...
@CucumberOptions(
        ...
        features = "src/test/java/ua/ek/bdd/features/search",
...
public class SearchTestBddRunner {
    ...
    @Test(groups = "search", description = "Runs Cucumber Scenarios", dataProvider = "scenarios")
    ...
    private List<CucumberTag> getFeaturesTags() {
        ...
        String sheetName = Helper.getProperty(PropertyFiles.COMMON_PROPERTY.getPropertyFileName(),
                PropertyNames.CUCUMBER_TAGS_SHEET_NAME_SEARCH.getPropertyName());
